...
export default function DriverVehicleInfo({ 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-sm font-medium text-gray-600">走行距離</span>
            </div>
            <p className="text-xl font-bold text-gray-900">{assignedVehicle.mileage.toLocaleString()}km</p>
          </div>

          <div className="bg-gray-50 rounded-lg p-4">
            <div className="flex items-center space-x-2 mb-2">
              <MapPin className="h-4 w-4 text-gray-600" />
              <span className="text-sm font-medium text-gray-600">駐車場所</span>
            </div>
            <p className="text-xl font-bold text-gray-900">{assignedVehicle.location}</p>
          </div>
  ...
  const renderHistory = () => (
    <div className="space-y-4">
      <h3 className="text-lg font-semibold text-gray-900">点検・メンテナンス履歴</h3>
      
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="space-y-4">
          <div className="border-l-4 border-green-500 pl-4 py-2">
            <div className="flex items-center justify-between mb-1">
              <h4 className="font-medium text-gray-900">定期点検</h4>
              <span className="text-sm text-gray-500">2024/01/15</span>
            </div>
            <p className="text-sm text-gray-600">12ヶ月定期点検を実施。異常なし。</p>
          </div>

          <div className="border-l-4 border-blue-500 pl-4 py-2">
            <div className="flex items-center justify-between mb-1">
              <h4 className="font-medium text-gray-900">オイル交換</h4>
              <span className="text-sm text-gray-500">2023/12/10</span>
            </div>
            <p className="text-sm text-gray-600">エンジンオイル交換（45,000km時点）</p>
          </div>

          <div className="border-l-4 border-yellow-500 pl-4 py-2">
            <div className="flex items-center justify-between mb-1">
              <h4 className="font-medium text-gray-900">タイヤ交換</h4>
              <span className="text-sm text-gray-500">2023/11/20</span>
            </div>
            <p className="text-sm text-gray-600">前輪タイヤ2本交換。摩耗による交換。</p>
          </div>
        </div>
      </div>
    </div>
